...
let testSample2 toolsPath =
    testCase
    |> withLog "can load sample2" (fun logger fs ->
...
let testSample3 toolsPath =
    testCase
    |> withLog "can load sample3" (fun logger fs ->
...
let testSample4 toolsPath =
    testCase
    |> withLog "can load sample4" (fun logger fs ->
...
let testSample5 toolsPath =
    testCase
    |> withLog "can load sample5" (fun logger fs ->
...
let testLoadSln toolsPath =
    testCase
    |> withLog "can load sln" (fun logger fs ->
...
let testSample9 toolsPath =
    testCase
    |> withLog "can load sample9" (fun logger fs ->
...
let testRender2 toolsPath =
    testCase
    |> withLog "can render sample2" (fun logger fs ->
...
let testRender3 toolsPath =
    testCase
    |> withLog "can render sample3" (fun logger fs ->
...
let testRender4 toolsPath =
    testCase
    |> withLog "can render sample4" (fun logger fs ->
...
let testRender5 toolsPath =
    testCase
    |> withLog "can render sample5" (fun logger fs ->
...
let testRender8 toolsPath =
    testCase
    |> withLog "can render sample8" (fun logger fs ->
...
let testProjectNotFound toolsPath =
    testCase
    |> withLog "project not found" (fun logger fs ->
...
let testFCSmap toolsPath =
    testCase
    |> withLog "can load sample2 with FCS" (fun logger fs ->
...
let testProjectSystem toolsPath =
    testCase
    |> withLog "can load sample2 with Project System" (fun logger fs ->
...
let testProjectSystemOnChange toolsPath =
    testCase
    |> withLog "can load sample2 with Project System, detect change on fsproj" (fun logger fs ->
