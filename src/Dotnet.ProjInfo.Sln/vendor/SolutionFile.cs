...
using ErrorUtilities = Dotnet.ProjInfo.Sln.Shared.ErrorUtilities;
using VisualStudioConstants = Dotnet.ProjInfo.Sln.Shared.VisualStudioConstants;
using ProjectFileErrorUtilities = Dotnet.ProjInfo.Sln.Shared.ProjectFileErrorUtilities;
using BuildEventFileInfo = Dotnet.ProjInfo.Sln.Shared.BuildEventFileInfo;
using ResourceUtilities = Dotnet.ProjInfo.Sln.Shared.ResourceUtilities;
using ExceptionUtilities = Dotnet.ProjInfo.Sln.Shared.ExceptionHandling;
using System.Collections.ObjectModel;

namespace Dotnet.ProjInfo.Sln.Construction
{
    /// <remarks>
            ...
            )
        {
            ...
            else
            {
                ...
                else if (String.Compare(propertyName, "TargetFrameworkMoniker", StringComparison.OrdinalIgnoreCase) == 0)
                {
                    ...
                    proj.TargetFrameworkMoniker = Dotnet.ProjInfo.Sln.Shared.EscapingUtilities.UnescapeAll(targetFrameworkMoniker);
                }
            }
        }
