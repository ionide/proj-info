...
using Dotnet.ProjInfo.Sln.Shared;
using Dotnet.ProjInfo.Sln.Utilities;
#if MICROSOFT_BUILD_TASKS
using MSBuildConstants = Microsoft.Build.Tasks.MSBuildConstants;
#else
using MSBuildConstants = Dotnet.ProjInfo.Sln.Shared.MSBuildConstants;
#endif


namespace Dotnet.ProjInfo.Sln
{
    /// <summary>
