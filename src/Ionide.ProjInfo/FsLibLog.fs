// Commit SHA 599e765db64ba5bcde23a589f427453c52fdb132
...
module Types =
    ...
    /// An interface wrapper for a<see cref="T:Ionide.ProjInfo.LoggingTypes.Logger">Logger</see>. Useful when using depedency injection frameworks.
    type ILog =
    ...
    module Log =
        ...
        /// <summary>
        /// Amends a <see cref="T:Ionide.ProjInfo.LoggingTypes.Log">Log</see> with a message.
        /// </summary>
        ...
        /// <summary>
        /// Amends a <see cref="T:Ionide.ProjInfo.LoggingTypes.Log">Log</see> with a message thunk.  Useful for "expensive" string construction scenarios.
        /// </summary>
        ...
        /// <summary>
        /// Amends a <see cref="T:Ionide.ProjInfo.LoggingTypes.Log">Log</see> with a parameter.
        /// </summary>
        ...
        /// <summary>
        /// Amends a <see cref="T:Ionide.ProjInfo.LoggingTypes.Log">Log</see> with a list of parameters.
        /// </summary>
        ...
        /// <summary>
        /// Amends a <see cref="T:Ionide.ProjInfo.LoggingTypes.Log">Log</see> with additional named parameters for context. This helper adds more context to a log.
        ...
        /// <summary>
        /// Amends a <see cref="T:Ionide.ProjInfo.LoggingTypes.Log">Log</see> with an <see cref="T:System.Exception">exn</see>. Handles nulls.
        /// </summary>
        ...
        /// <summary>
        /// Amends a <see cref="T:Ionide.ProjInfo.LoggingTypes.Log">Log</see> with a given <see cref="T:Ionide.ProjInfo.LoggingTypes.LogLevel">LogLevel</see>
        /// </summary>
        ...
        /// <summary>
        /// Amends a <see cref="T:Ionide.ProjInfo.LoggingTypes.Log">Log</see> with a given interpolated string. This will generate a message template from a special syntax within the interpolation. The syntax for the interplated string is <code> $"I want to log {myVariable:MyLogVariableName}". </code>
        ///
...
module Operators =
    ...
    /// <summary>
    /// Amend a log with a message. Wrapper for <see cref="M:Ionide.ProjInfo.LoggingTypes.LogModule.setMessage">Log.setMessage</see>.
    /// </summary>
    ...
    /// <summary>
    /// Amends a log with a parameter. Wrapper for <see cref="M:Ionide.ProjInfo.LoggingTypes.LogModule.addParameter">Log.addParameter</see>.
    /// </summary>
    ...
    ///
    /// Wrapper for <see cref="M:Ionide.ProjInfo.LoggingTypes.LogModule.addContext">Log.addContext</see>.
    /// </summary>
    /// <param name="log">The log to add the parameter to.</param>
    ...
    ///
    /// Wrapper for <see cref="M:Ionide.ProjInfo.LoggingTypes.LogModule.addContextDestructured">Log.addContextDestructured</see>.
    /// </summary>
    /// <param name="log">The log to add the parameter to.</param>
    /// <param name="key">The name for the parameter.</param>
    /// <param name="value">The value for the parameter.</param>
    ...
    ///
    /// Wrapper for <see cref="M:Ionide.ProjInfo.LoggingTypes.LogModule.addException">Log.addException</see>.
    /// </summary>
    /// <param name="log">The log to add the parameter to.</param>
...
module Providers =
    module SerilogProvider =
        ...
        type private SeriLogProvider() =
            ...
            interface ILogProvider with
                ...
                member this.OpenMappedContext (key: string) (value: obj) (destructure: bool) : IDisposable = pushProperty key value destructure
    ...
    module MicrosoftExtensionsLoggingProvider =
        ...
        let isAvailable () =
            getLogFactoryType.Value |> isNull |> not && microsoftLoggerFactory |> Option.isSome
            ...
            static member Create() =
                ...
                let write, writeError =
                    ...
                    let write =
                        ...
                        let expression =
                            Expression.Lambda<Action<ILogger, MicrosoftLogLevel, MessageFormat, MessageArgs>>(writeMethodExp, instanceParam, levelParam, messageParam, propertyValuesParam)
                    ...
                    let writeError =
                        ...
                        let writeMethodExp =
                            Expression.Call(null, writeMethodInfo, instanceCast, levelCast, exnParam, messageParam, propertyValuesParam)

                        let expression =
                            Expression.Lambda<Action<ILogger, MicrosoftLogLevel, exn, MessageFormat, MessageArgs>>(writeMethodExp, instanceParam, levelParam, exnParam, messageParam, propertyValuesParam)
...
module LogProvider =
    ...
    let private resolvedLogger =
        lazy (knownProviders |> Seq.tryFind (fun (isAvailable, _) -> isAvailable ()) |> Option.map (fun (_, create) -> create ()))
    ...
    /// </summary>
    /// <param name="logProvider">The <see cref="M:Ionide.ProjInfo.LoggingTypes.ILogProvider"/> to set</param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Creates a logger given a <see cref="T:System.String">string</see>. This will attempt to retrieve any loggers set with <see cref="M:Ionide.ProjInfo.LoggingLogProviderModule.setLoggerProvider">Log.setLoggerProvider</see>.  It will fallback to a known list of providers.
    /// </summary>
    ...
    /// <summary>
    /// Creates a logger given a <see cref="T:System.Type">Type</see>.  This will attempt to retrieve any loggers set with <see cref="M:Ionide.ProjInfo.LoggingLogProviderModule.setLoggerProvider">Log.setLoggerProvider</see>.  It will fallback to a known list of providers.
    /// </summary>
    ...
    /// <summary>
    /// Creates a logger given a <c>'a</c> type. This will attempt to retrieve any loggers set with <see cref="M:Ionide.ProjInfo.LoggingLogProviderModule.setLoggerProvider">Log.setLoggerProvider</see>.  It will fallback to a known list of providers.
    /// </summary>
