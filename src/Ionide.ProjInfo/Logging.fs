namespace Ioniode.ProjInfo.Logging
    ...
    module SerilogProvider =
        ...
        type SerilogGateway =
            ...
            static member Create() =
                ...
                let writeMethodExp = Expression.Call(instanceCast, writeExceptionMethodInfo, levelCast, exceptionParam, messageParam, propertyValuesParam)
